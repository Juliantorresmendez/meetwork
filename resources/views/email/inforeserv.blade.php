...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		.templateHeader{
			/*@editable*/background-color:#576eae;
			border-top:0;
			border-bottom:0;
			padding-bottom:10px;
		}
	...
	*/
    ...
    <body>
        <!--*|IF:MC_PREVIEW_TEXT|*-->
        <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Has generado una reserva en este establecimiento, estamos verificando la disponibilidad de un espacio de trabajo, en pocos minutos te confirmaremos.</span><!--<![endif]-->
        <!--*|END:IF|*-->
        <center>
									...
									<table align="left" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="left" valign="middle">
												<img src="https://gallery.mailchimp.com/87ce8f25ff95a7f203c76c0ab/images/47662b23-df38-45d4-8005-9b2f50193f4b.png" height="30" width="15" style="boder:0; display:block;">
											</td>
											<td align="left" valign="middle" width="100%"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width:100%;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1><span style="color:#FFFFFF"><font face="lato, helvetica neue, helvetica, arial, sans-serif">Información</font><span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">&nbsp;de tu reserva</span></span></h1>
&nbsp;

<h3><span style="color:#FFFFFF">{{$reserv->site->name}}</span></h3>
{{$reserv->site->address}}
                        </td>
                    </tr>
                </tbody></table>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://s3.amazonaws.com/meetworks/full/{{$reserv->site->id}}/{{$reserv->site->images[0]->url}}" width="590" style="max-width:634px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">
                            ...
                            <p style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><font face="lato, helvetica neue, helvetica, arial, sans-serif"><span style="font-size:15px">Has generado una reserva en este establecimiento, estamos verificando&nbsp;la disponibilidad&nbsp;de un espacio de trabajo, en pocos minutos te confirmaremos.</span></font></p>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 5px solid #FFFFFF;background-color: #576EAE;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; padding: 15px;">
                                <a class="mcnButton " title="IR A MIS RESERVAS" href="https://meetwork.co/profile" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">IR A MIS RESERVAS</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                                                                                ...
                                                                                                <?php
                                                                                                $date= explode("-", $reserv->date_reservation);
                                                                                                if($date[1]=="01"){
                                                                                                    $dateString="Enero";
															...
															<table border="0" cellpadding="5" cellspacing="5" width="150" id="calendarContainer">
																<tr>
																	<td align="center" bgcolor="#EFEFEF" valign="top" id="monthContainer">
																		<div mc:edit="month"><span style="color:#FFFFFF"><span style="font-size:24px"><strong><span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">{{$dateString}}</span></strong></span></span></div>
																	</td>
																</tr>
																<tr>
																	<td align="center" valign="top" id="dayContainer">
																		<div mc:edit="day"><span style="color:#696969">{{$date[2]}}</span></div>
																	</td>
																</tr>
                                                                                                                            
                                                                                                                                <tr>
																	<td align="center" valign="top" id="HourContainer">
																		<div mc:edit="time"><span style="color:#696969">{{$reserv->time}}:00 Hs</span></div>
																	</td>
																</tr>
															</table>
														</td>
											...
											<td align="right" valign="top" style="padding-top:18px;">
												<img src="https://gallery.mailchimp.com/87ce8f25ff95a7f203c76c0ab/images/03c9e5d8-4a2f-471e-b646-37327134c2b0.png" height="30" width="15" style="boder:0; display:block;">
											</td>
										</tr>
									</table>
								</td>
								...
								<td valign="top" id="templateLowerBody">
									<table align="left" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											...
											<td align="left" valign="middle" width="100%"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnFollowBlock" style="min-width:100%;">
                                    ...
                                    <![endif]-->
                                        ...
                                        <![endif]-->
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnFollowStacked" style="display:inline;">
                                                ...
                                                <tbody><tr>
                                                    <td align="center" valign="top" class="mcnFollowIconContent" style="padding-right:10px; padding-bottom:9px;">
                                                        <a href="https://www.instagram.com/meetwork.co/" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-light-instagram-96.png" alt="Instagram" class="mcnFollowBlockIcon" width="48" style="width:48px; max-width:48px; display:block;"></a>
                                                    </td>
                                                </tr>
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnFollowStacked" style="display:inline;">
                                                ...
                                                <tbody><tr>
                                                    <td align="center" valign="top" class="mcnFollowIconContent" style="padding-right:0; padding-bottom:9px;">
                                                        <a target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-light-linkedin-96.png" alt="LinkedIn" class="mcnFollowBlockIcon" width="48" style="width:48px; max-width:48px; display:block;"></a>
                                                    </td>
                                                </tr>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #FFFFFF;font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">
