...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		#calendarContainer{
			/*@editable*/background-color:#ffffff;
			/*@editable*/border:5px solid #576eae;
		}
	/*
	@tab Sidebar
	 Calendar Month Text
	...
	*/
    ...
    <body>
        <!--*|IF:MC_PREVIEW_TEXT|*-->
        <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">En este establecimiento ya hay muchos Coworkers trabajando.</span><!--<![endif]-->
        <!--*|END:IF|*-->
        <center>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1><font color="#ffffff">¡ Seguimos creciendo !</font></h1>
En este establecimiento ya hay muchos Coworkers trabajando.
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/66f592d473385e4197d8a9554/images/1bfb2be2-2be8-490c-9776-0611a68874e3.png" width="590" style="max-width:634px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
...
<span style="font-size:20px"><span style="color:#576EAE"><strong>&nbsp;No te preocupes,<br>
tenemos más&nbsp;espacios disponibles</strong></span></span><br>
&nbsp;</div>

<div style="text-align: center;">¿Por favor indícanos qué hacemos por ti?<br>
&nbsp;</div>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; padding: 15px;">
                                <a class="mcnButton " title="¿ Buscamos otro espacio ?" href="https://meetwork.co/" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">¿ Buscamos otro espacio ?</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
												...
												<table align="left" border="0" cellpadding="0" cellspacing="0" width="186" id="templateSidebar">
															...
															<table border="0" cellpadding="5" cellspacing="5" width="150" id="calendarContainer">
																<tr>
																	<td align="center" bgcolor="#EFEFEF" valign="top" id="monthContainer">
																		<div mc:edit="month"><span style="font-size:24px"><span style="color:#FFFFFF"><strong><span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">{{$dateString}}</span></strong></span></span></div>
																	</td>
																</tr>
																<tr>
													...
													<tr>
														<td valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonBlock" style="min-width:100%;">
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 5px solid #FFFFFF;background-color: #576EAE;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Reagendamos" href="https://meetwork.co/site/{{$reserv->site->id}}/{{urlencode($reserv->site->name)}}" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Reagendamos</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
