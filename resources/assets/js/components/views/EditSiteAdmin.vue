                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <Vueditor v-model="site.description" ref="textDescription" placeholder="Descripción"></Vueditor>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <select class="dropDown-Simple" v-model="site.status_id">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <v-select label="name" :filterable="false" :options="optionsAdmins" @search="onSearch">
...
<script>
    ...
    search: _.debounce((loading, search, vm) => {
        var _this=this;
       axios.get('/searchAdmin?name='+escape(search))
                                .then(response => vm.processAdmins(response.data,vm,loading))
                                .catch(error => console.log(error));
    }, 350),
                    
                    processAdmins(data,vm,loading){
                        vm.optionsAdmins=data.items;
                      /*  console.log(data.json());
                        data.json().then(json => (vm.optionsAdmins = json.items));
                    //  this.optionsAdmins=  data;*/
                              loading(false);
                    ...
                    formatSite(data) {
                        console.log("aqui manooo");
                        this.site = data;

                        let editor = this.$refs.textDescription;
                        editor.setContent(this.site.description);
   ...
   for (var i = 0; i < data.images.length; i++) {
                    ...
                    deleteImage(image) {
                        if (!!image.data) {
                            axios.delete('/deleteAdminImage/' + this.site.id + '/' + image.data.id)
                    ...
                    publishSite() {
                        ...
                        this.site.description = editor.getContent(); 
                console.log("aquiiii ->" +editor.getContent() );
                        axios.post('/editAdminSite', this.site)
