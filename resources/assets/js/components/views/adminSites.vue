<template>
    <div class="site-container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 container-description-site profile-container-general">
                <h2>Lugares Listado</h2>
                ...
                <div class="row">
                    <button style="margin: auto;margin-bottom: 30px;" class="btn-purple" v-on:click="viewMoreSites()">Ver Mas Sitios</button>
                </div>
            ...
            export default {
                ...
                methods: {
                    ...
                    popupClickedList(data) {
                        window.open("/editadmin/"+data.id)
                    },
                    getSites(page) {
                        
                        axios.get('/getAdmiSites?page='+page+'&services=' + this.serviceArray + '&selectedSpace=' + this.spaceArray+'&siteSearch='+this.siteSearch+'&status_id='+this.status_id)
